...
<h1 align="center" style="font-size: 50px;">
  <strong>Northville II Multi-Purpose Cooperative</strong>
</h1>

<div align="center">

[![Download](https://github.com/user-attachments/assets/0dd64329-8c6f-484a-84b1-b7067182df3f)](https://github.com/SushiMini/WebsitePrototype/releases)
...
[![Join Discord](https://github.com/user-attachments/assets/b82119fd-8e2b-49f7-83f2-d35e61d5a714)](https://discord.com/channels/1256588862130622537/1256588863179067444)
...
Cooperatives are **people-centered enterprises** owned, controlled, and run by and for their members to realize their common economic, social, and cultural needs and aspirations. They bring people together in a democratic and equal way.
...
- [WebsitePrototype](https://github.com/SushiMini/WebsitePrototype/releases): In-progress website.
- [XAMPP](https://www.apachefriends.org/): Local server setup for PHP/MySQL.
...
3. Add `index.html` and `script.php` to your project folder.
4. Start **Apache** and **MySQL** from the XAMPP Control Panel.
5. Open [phpMyAdmin](http://localhost/phpmyadmin/).
6. Click the **Import** tab, choose the `phplogin.sql` file from your project folder, and click **Import**.
7. Visit `http://localhost/yourprojectfolder/index.html` for your HTML and `http://localhost/yourprojectfolder/script.php` for PHP.
